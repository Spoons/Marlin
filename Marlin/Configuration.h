...
#define STRING_SPLASH_LINE1 "cats are good" // will be shown during bootup in line 1
#define STRING_SPLASH_LINE2 "meowmeow"         // will be shown during bootup in line 2
